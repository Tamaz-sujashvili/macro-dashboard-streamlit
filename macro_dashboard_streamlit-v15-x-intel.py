...
# ── PAGE CONFIG ───────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Macro Regime Terminal",
    page_icon=None,
    layout="wide",
    initial_sidebar_state="expanded")

# ── GLOBAL UI THEME (terminal) ────────────────────────────────────────────────
# Futuristic terminal aesthetic. Pure presentation layer: does not modify any
# data, calculations, or Plotly chart definitions.
inject_theme()
...
def _render_terminal_header(fred, mkt, consensus=None) -> None:
    ...
    ``consensus`` is pre-computed in ``main()`` so the header never blocks tabs.
    """
    try:
        if consensus is None:
            _, consensus, _, _ = get_regime_consensus(fred, mkt)
        ...
        elif daily_label == "Risk-Off":
            badge_color = COLORS["risk_off"]
            badge_prefix = "RISK-OFF"
        elif daily_label == "Neutral":
            badge_color = COLORS["neutral"]
            badge_prefix = "NEUTRAL"
        else:
    ...
    st.markdown(
        ...
        f'letter-spacing:0.1em;text-transform:uppercase;color:{COLORS["text"]};">'
        f'MACRO REGIME TERMINAL</div>'
        f'<div style="font-family:JetBrains Mono,monospace;font-size:12px;color:{COLORS["muted"]};">'
        f'{utc_ts}</div>'
...
FRED_API_KEY       = get_api_key("FRED_API_KEY") or ""
ALPHA_VANTAGE_KEY  = get_api_key("ALPHA_VANTAGE_KEY") or ""
BLS_API_KEY        = get_api_key("BLS_API_KEY") or ""
EIA_API_KEY        = get_api_key("EIA_API_KEY") or ""
FMP_API_KEY        = get_api_key("FMP_API_KEY") or ""
CFTC_APP_TOKEN     = get_api_key("CFTC_APP_TOKEN") or ""
...
def _http_get(url, timeout=12):
    # Prefer curl when available: Python's urllib3 SSL handshake to some hosts
    # (notably fred.stlouisfed.org) can hang/timeout on this machine while curl
...
THRESHOLDS = {
    "CPIAUCSL"       : [(2.5, "OK"), (4.0, "WATCH"), (1e9, "ALERT")],
    "CPILFESL"       : [(2.5, "OK"), (3.5, "WATCH"), (1e9, "ALERT")],
    "PCEPILFE"       : [(2.5, "OK"), (3.5, "WATCH"), (1e9, "ALERT")],
    "T10YIE"         : [(2.5, "OK"), (3.5, "WATCH"), (1e9, "ALERT")],
    "UNRATE"         : [(4.5, "OK"), (6.0, "WATCH"), (1e9, "ALERT")],
    "U6RATE"         : [(8.0, "OK"), (10.0,"WATCH"), (1e9, "ALERT")],
    "ICSA"           : [(250,  "OK"), (350, "WATCH"), (1e9, "ALERT")],
    "CIVPART"        : [(62.0, "ALERT"), (63.5,"WATCH"), (1e9, "OK")],
    "GDPNOW"         : [(0.0,  "ALERT"), (2.0, "WATCH"), (1e9, "OK")],
    "A191RL1Q225SBEA": [(0.0,  "ALERT"), (2.0, "WATCH"), (1e9, "OK")],
    "INDPRO"         : [(-1.0, "ALERT"), (0.0, "WATCH"), (1e9, "OK")],
    "USSLIND"        : [(0.0,  "ALERT"), (0.3, "WATCH"), (1e9, "OK")],
    "WEI"            : [(0.0,  "ALERT"), (0.5, "WATCH"), (1e9, "OK")],
    "CFNAI"          : [(-1.0, "ALERT"), (0.0, "WATCH"), (1e9, "OK")],
    "SAHMREALTIME"   : [(0.3, "OK"), (0.5, "WATCH"), (1e9, "ALERT")],
    "DFF"            : [(3.0,  "OK"), (5.5, "WATCH"), (1e9, "ALERT")],
    "BAMLH0A0HYM2"   : [(300,  "OK"), (500, "WATCH"), (1e9, "ALERT")],
    "BAMLC0A0CM"     : [(100,  "OK"), (200, "WATCH"), (1e9, "ALERT")],
    "NFCI"           : [(-0.5, "OK"), (0.5, "WATCH"), (1e9, "ALERT")],
    "STLFSI2"        : [(-0.5, "OK"), (0.5, "WATCH"), (1e9, "ALERT")],
    "T10Y3M"         : [(-0.5, "ALERT"), (0.0, "WATCH"), (1e9, "OK")],
    "T10Y2Y"         : [(-0.5, "ALERT"), (0.0, "WATCH"), (1e9, "OK")],
    "T30Y2Y"         : [(-0.5, "ALERT"), (0.0, "WATCH"), (1e9, "OK")],
    "SOFR"           : [(0.0, "OK"), (5.0, "WATCH"), (1e9, "ALERT")],
    "SOFR30DAYAVG"   : [(0.0, "OK"), (5.0, "WATCH"), (1e9, "ALERT")],
    "SOFR90DAYAVG"   : [(0.0, "OK"), (5.0, "WATCH"), (1e9, "ALERT")],
    "SOFR180DAYAVG"  : [(0.0, "OK"), (5.0, "WATCH"), (1e9, "ALERT")],
    "TEDRATE"        : [(0.3, "OK"), (0.5, "WATCH"), (1e9, "ALERT")],
    "DRTSCILM"       : [(20,  "WATCH"), (40,  "ALERT"), (1e9, "ALERT")],
    "WRMFNS"         : [(5000, "OK"), (6000, "WATCH"), (1e9, "ALERT")],
    "WRMFSL"         : [(2000, "OK"), (3000, "WATCH"), (1e9, "ALERT")],
    "UMCSENT"        : [(60.0, "ALERT"), (80.0,"WATCH"), (1e9, "OK")],
    "PSAVERT"        : [(3.0,  "ALERT"), (8.0, "WATCH"), (1e9, "OK")],
    "MORTGAGE30US"   : [(6.0,  "OK"), (7.0, "WATCH"), (1e9, "ALERT")],
    "MORTGAGE15US"   : [(5.5,  "OK"), (6.5, "WATCH"), (1e9, "ALERT")],
    "MSPNHSUS"        : [(550, "ALERT"), (700, "WATCH"), (1e9, "OK")],
    "RECPROUSM156N"  : [(10,   "OK"), (30,  "WATCH"), (1e9, "ALERT")],
    "SHILLER_CAPE"   : [(20,   "OK"), (30,  "WATCH"), (1e9, "ALERT")],
    "AAII_BEAR"      : [(20,   "OK"), (40,  "WATCH"), (1e9, "ALERT")],
    "AAII_SPREAD"    : [(-10,  "ALERT"), (10,  "WATCH"), (1e9, "OK")],
    "SPREAD_2_10"    : [(0,    "ALERT"), (0.5, "WATCH"), (1e9, "OK")],
}
...
def fetch_fred():
    try:
        ...
        def _fredgraph_req(series_id, units="lin", limit=5, record_error=True):
            ...
            last_error = None
            # Shorter timeouts when curl is the transport: curl failures are fast,
            # so long Python-only timeouts become the bottleneck.
            timeout_seq = (5, 8, 12) if _CURL_AVAILABLE else (12, 20, 30)
            for attempt, timeout in enumerate(timeout_seq, start=1):
                try:
                    ...
                    # FREDGraph CSV uses ``observation_date`` + series-id column.
        ...
        results["_fetched_at"] = datetime.datetime.now()
        return results
    ...
    try:
        ...
        def _fetch_one(sym):
            try:
                ...
                try:
                    intraday = ticker.history(period="5d", interval="1m", prepost=True, timeout=20)
                ...
                try:
                    daily = ticker.history(period="10d", interval="1d", prepost=False, timeout=20)
...
def fetch_yfinance_close_history(symbol, period="1y", interval="1d"):
    ...
    try:
        import yfinance as yf
        hist = yf.Ticker(symbol).history(period=period, interval=interval, timeout=20)
...
def fetch_premarket_snapshot():
    ...
    try:
        ...
        def _fetch_one(sym, label):
            try:
                ticker = yf.Ticker(sym)
                hist = ticker.history(period="10d", interval="15m", prepost=True, timeout=20)
                if hist is None or hist.empty or "Close" not in hist.columns:
                    return sym, None
                ...
                info = ticker.fast_info
                prev = getattr(info, "previous_close", None)
                daily = ticker.history(period="15d", interval="1d", prepost=False, timeout=20)
                daily_close = None
                sessions_5d = []
                if daily is not None and not daily.empty and "Close" in daily.columns:
...
def fetch_sofr_futures_strip():
    ...
    try:
        ...
        for ticker, label, expiry in candidates:
            try:
                hist = yf.Ticker(ticker).history(period="5d", interval="1d", timeout=20)
                if hist is None or hist.empty or "Close" not in hist.columns:
                    continue
...
def fetch_amihud_illiquidity(ticker="SPY", lookback=30):
    ...
    try:
        import yfinance as yf
        t = yf.Ticker(ticker)
        hist = t.history(period=f"{lookback + 5}d", timeout=20)
...
def compute_gs_panic_proxy(mkt, opts, skew_idx, pcr_hist):
    ...
    try:
        ...
        try:
            vix_hist = yf.Ticker("^VIX").history(period="2y", timeout=20)[["Close"]].dropna()
        ...
        try:
            vvix_hist = yf.Ticker("^VVIX").history(period="2y", timeout=20)[["Close"]].dropna()
        ...
        try:
            skew_hist = yf.Ticker("^SKEW").history(period="2y", timeout=20)[["Close"]].dropna()
...
def fetch_options_chain_data(ticker_sym="SPY"):
    ...
    try:
        ...
        if spot is None:
            hist = ticker.history(period="5d", interval="1d", timeout=20)
            if not hist.empty:
...
def _status_color(sid, v):
    ...
    for threshold, dot in THRESHOLDS[sid]:
        if v <= threshold:
            return "#34d399" if dot=="OK" else "#f87171" if dot=="ALERT" else "#fbbf24"
    return None
...
TAB_DISPLAY_LABELS = {
    ...
    "BOND AUCTIONS": "Bond Auctions",
    "LABOR & CONSUMER": "Jobs, Wages & Spending",
    "MARKETS": "Markets & Investor Mood",
    ...
    "LIQUIDITY": "Money & Credit Conditions",
    "FLOWS": "Big Money Flows",
    "SENTIMENT": "Investor Mood Framework",
    "COMPOSITES": "Composite Risk Scores",
    "GLOBAL MACRO": "Global Macro",
    "AI ANALYSIS": "AI Economic Analysis",
    "X INTEL": "X Intelligence",
}
...
ALERT_REWRITES = [
    ("VIX term structure in backwardation", "Heightened near-term risk: Options traders are paying up for crash protection right now, not just months from now. This often appears before sharp market moves."),
    ("VIX Backwardation detected", "Heightened near-term risk: Options traders are paying up for crash protection right now, not just months from now. This often appears before sharp market moves."),
...
def render_tab_summary(tab_key, fred, treasury=None, mkt=None, fg=None, naaim=None, cape=None, extra=None):
    ...
    summaries = {
        ...
        "MARKETS": (
            f" **Today's Market Tape ({today})**\n"
            f"This tab tracks prices, breadth, and capital flows. "
            f"For the consolidated risk-on / risk-off verdict, see the REGIME MONITOR tab."
        ),
        "BOND AUCTIONS": (
...
def compute_regime_state(fred, lookback_days=60, energy_curve=None):
    ...
    df = pd.merge_asof(
        ...
        left_on="target_date",
        right_on="lag_date",
        direction="backward").sort_values("date").reset_index(drop=True)
...
def render_data_diagnostics(fred, treasury, mkt, fg, naaim, cape, aaii, news, bls):
    ...
    with st.expander("Data diagnostics", expanded=bool(missing_critical)):
        ...
        if _FRED_ERRORS:
            ...
            st.dataframe(style_dataframe(fred_errs), use_container_width=True, hide_index=True)
...
def make_yield_curve_chart(treasury):
    ...
    apply_house_style(fig, title=f"US Treasury Yield Curve  —  {date_str}", height=360)
    fig.update_layout(
...
def make_inflation_bar_chart(fred):
    ...
    apply_house_style(fig, title="Inflation Components", height=200)
    fig.update_layout(
        xaxis_title="%",
        showlegend=False)
    return fig
...
def make_gauge_chart(value, title, min_val=0, max_val=100,
    ...
    accent = thresholds[-1][1] if thresholds else "#3b82f6"
    fig = go.Figure(go.Indicator(
        mode="gauge+number",
        value=value if value is not None else 0,
        title={"text": title, "font": {"family": "JetBrains Mono, monospace", "size": 11, "color": COLORS["muted"]}},
        number={"suffix": "", "font": {"family": "JetBrains Mono, monospace", "size": 24, "color": COLORS["text"]}},
        gauge={
            "axis": {"range": [min_val, max_val], "tickcolor": "#1e2733", "tickfont": {"family": "JetBrains Mono, monospace", "size": 9, "color": COLORS["muted"]}},
            "bar": {"color": accent, "thickness": 0.15},
            "bgcolor": "#11161f",
            "bordercolor": "#1e2733",
            "borderwidth": 1,
            "steps": [],
    ...
    apply_house_style(fig, height=200)
    return fig
...
def make_composite_gauge(value, title, subtitle="", low_label="Low", high_label="High"):
    accent = "#3b82f6" if value is None else "#34d399" if value < 40 else "#fbbf24" if value < 65 else "#f87171"
    fig = go.Figure(go.Indicator(
        mode="gauge+number",
        value=0 if value is None else float(value),
        title={"text": f"{title}<br><span style='font-size:11px;color:#94a3b8'>{subtitle}</span>", "font": {"family": "JetBrains Mono, monospace", "size": 11, "color": COLORS["muted"]}},
        number={"suffix": "/100", "font": {"family": "JetBrains Mono, monospace", "size": 26, "color": COLORS["text"]}},
        gauge={
            "axis": {"range": [0, 100], "tickcolor": "#1e2733", "tickfont": {"family": "JetBrains Mono, monospace", "size": 9, "color": COLORS["muted"]}},
            "bar": {"color": accent, "thickness": 0.15},
            "bgcolor": "#11161f",
            "bordercolor": "#1e2733",
            "borderwidth": 1,
    ...
    fig.add_annotation(text=low_label, x=0.14, y=0.06, xref="paper", yref="paper",
                       showarrow=False, font=dict(family="JetBrains Mono, monospace", color=COLORS["muted"], size=10))
    fig.add_annotation(text=high_label, x=0.86, y=0.06, xref="paper", yref="paper",
                       showarrow=False, font=dict(family="JetBrains Mono, monospace", color=COLORS["muted"], size=10))
    apply_house_style(fig, height=240)
    return fig
...
def make_composite_history_chart(history, title, y_title="Score"):
    fig = go.Figure()
    if not history:
        apply_house_style(fig, title=f"{title} — insufficient history", height=260)
        return fig
    ...
    apply_house_style(fig, title=title, height=260)
    fig.update_layout(
...
def make_sahm_rule_gauge(fred):
    ...
    accent = "#94a3b8" if value is None else "#f87171" if value >= 0.5 else "#fbbf24" if value >= 0.3 else "#34d399"
    fig = go.Figure(go.Indicator(
        mode="gauge+number",
        value=0 if value is None else float(value),
        title={"text": "Sahm Rule Real-Time<br><span style='font-size:11px;color:#94a3b8'>0.5 = recession signal</span>", "font": {"family": "JetBrains Mono, monospace", "size": 11, "color": COLORS["muted"]}},
        number={"suffix": " pts", "font": {"family": "JetBrains Mono, monospace", "size": 26, "color": COLORS["text"]}},
        gauge={
            "axis": {"range": [0, 1.2], "tickcolor": "#1e2733", "tickfont": {"family": "JetBrains Mono, monospace", "size": 9, "color": COLORS["muted"]}},
            "bar": {"color": accent, "thickness": 0.15},
            "threshold": {"line": {"color": "#ffffff", "width": 1}, "thickness": 0.8, "value": 0.5},
            "bgcolor": "#11161f",
            "bordercolor": "#1e2733",
            "borderwidth": 1,
            "steps": [],
...
def make_fred_history_line_chart(fred, key, title, y_title="", color="#3b82f6", zero_line=False):
    ...
    fig = go.Figure()
    if not history:
        apply_house_style(fig, title=f"{title} — insufficient data", height=260)
        return fig
    fig.add_trace(go.Scatter(
...
def make_credit_spread_comparison_chart(fred):
    ...
    apply_house_style(fig, title="HY vs IG Credit Spread Comparison", height=300)
    fig.update_layout(
...
def make_macro_surprise_chart(composite_data):
    ...
    fig = go.Figure()
    if not rows:
        apply_house_style(fig, title="Macro Surprise Index — insufficient data", height=260)
        return fig
    ...
    apply_house_style(
        fig, title="Macro Surprise Proxy — Actual Change vs Prior Release", height=280
    )
    fig.update_layout(yaxis_title="Relative change proxy")
    return fig
...
def make_aaii_bar(aaii):
    ...
    apply_house_style(fig, title="AAII Investor Sentiment", height=220)
...
def make_credit_spreads_chart(fred):
    ...
    apply_house_style(fig, title="Credit Spreads", height=200)
    return fig
...
def make_regime_quadrant_chart(regime_state):
    ...
    apply_house_style(fig, title="Macro Regime Quadrant", height=360)
    fig.update_layout(
        showlegend=False,
...
def make_quality_rotation_chart(mkt):
    ...
    if all(value is None for value in values):
        fig = go.Figure()
        apply_house_style(
            fig, title="Capital Flow — Quality Rotation Signal (Daily)", height=220
        )
        return fig
...
def make_max_pain_chart(chain_data):
    ...
    fig.add_trace(go.Bar(
        ...
        opacity=0.45,
        name="Total OI (K)",
        hovertemplate="Strike %{x:.0f}<br>Total OI %{y:.1f}K<extra></extra>"), secondary_y=False)
    fig.add_trace(go.Scatter(
        x=pain_df["strike"], y=pain_df["pinning_score"] * 100.0,
        mode="lines+markers",
        line=dict(color="#fbbf24", width=2),
        name="Pinning Pressure Proxy",
        hovertemplate="Strike %{x:.0f}<br>Pinning score %{y:.1f}<extra></extra>"), secondary_y=True)
...
def make_gs_panic_gauge(panic_data):
    ...
    fig = go.Figure(go.Indicator(
        mode="gauge+number",
        value=score,
        title={"text": "GS Panic Index Proxy", "font": {"family": "JetBrains Mono, monospace", "size": 11, "color": COLORS["muted"]}},
        number={"font": {"family": "JetBrains Mono, monospace", "size": 36, "color": color}, "suffix": "/10"},
        gauge={
            "axis": {
                "range": [0, 10],
                "tickvals": [0, 2, 4, 6, 8, 10],
                "tickcolor": "#1e2733",
                "tickfont": {"family": "JetBrains Mono, monospace", "size": 9, "color": COLORS["muted"]},
            },
    ...
    apply_house_style(fig, height=250)
    return fig
...
def render_macro_alerts(fred, energy_curve=None):
    ...
    if gdp_v is not None:
        if gdp_v < 0:
            terminal_badge(f"Recession Warning: GDP contracting at {gdp_v:.1f}%", "error")
        elif gdp_v < 1.5:
            terminal_badge(f"Slowdown: Growth losing momentum at {gdp_v:.1f}%", "warning")
        else:
            terminal_badge(f"Economy expanding at {gdp_v:.1f}%", "success")

    if cpi_v is not None:
        if cpi_v > 4:
            terminal_badge(f"Inflation elevated at {cpi_v:.1f}% — well above 2% target", "error")
        elif cpi_v > 2.5:
            terminal_badge(f"Inflation at {cpi_v:.1f}% — above 2% Fed target", "warning")

    if rec_v is not None and rec_v > 50:
        terminal_badge(f"Recession probability above 50% ({rec_v:.0f}%)", "error")

    if un_v is not None and un_v > 6:
        terminal_badge(f"Unemployment elevated at {un_v:.1f}% — labor market weakening", "warning")

    if hy_v is not None and hy_v > 500:
        terminal_badge(f"HY credit spread at {hy_v:.0f} bp — credit stress elevated", "error")

    if sahm_v is not None:
        if sahm_v >= 0.5:
            terminal_badge("Sahm Rule triggered — real-time recession signal fired", "error")
        elif sahm_v >= 0.3:
            terminal_badge(f"Sahm Rule at {sahm_v:.2f} — approaching recession threshold", "warning")
    if psavert_v is not None and psavert_v < 3.5:
        terminal_badge(f"Personal savings rate at {psavert_v:.1f}% — consumer buffer critically thin", "warning")
    if ig_v is not None:
        if ig_v > 200:
            terminal_badge(f"IG credit spread at {ig_v:.0f}bp — credit market seizing up", "error")
        elif ig_v > 150:
            terminal_badge(f"IG credit spread at {ig_v:.0f}bp — investment-grade stress building", "warning")
    if m2_yoy is not None and m2_yoy < 0:
        terminal_badge("M2 money supply contracting YoY — liquidity headwind", "warning")
    if umich_v is not None and umich_v < 65:
        terminal_badge(f"Consumer sentiment at {umich_v:.1f} — household confidence deteriorating", "warning")
    ...
    if energy_curve is not None and not energy_curve.empty:
        ...
        if spread_1m is not None and spread_1m < 0:
            terminal_badge("WTI backwardation — supply squeeze signal", "error")
        if spread_1m is not None and spread_6m is not None and spread_1m > 0 and spread_6m > 15:
            terminal_badge("Deep contango — market sees near-term oversupply", "warning")
        if wti_brent is not None and wti_brent < -10:
            terminal_badge("Brent premium > $10 — geopolitical risk or US glut", "warning")
        ...
        try:
            if isinstance(energy_curve, pd.DataFrame) and not energy_curve.empty:
                ...
                if chg6v is not None and abs(chg6v) >= 0.20:
                    ...
                    terminal_badge(f"6M spread velocity: {chg6v:+.2f} $/bbl today - curve is {direction_v} rapidly. Watch for regime shift.", "warning")
        except Exception:
            pass
...
def render_labor_alerts(fred):
    ...
    if un_v is not None:
        if un_v > 6:
            terminal_badge(f"Unemployment at {un_v:.1f}% — significantly elevated", "error")
        elif un_v > 4.5:
            terminal_badge(f"Unemployment rising to {un_v:.1f}%", "warning")
        else:
            terminal_badge(f"Labor market healthy — Unemployment at {un_v:.1f}%", "success")

    if icsa is not None and icsa > 350:
        terminal_badge(f"Jobless claims elevated: {icsa:,.0f}K/week", "warning")
...
def render_energy_futures(futures_curve):
    ...
    with st.expander("Raw cleaned WTI spread rows"):
        ...
        st.dataframe(style_dataframe(futures_curve[cols]), use_container_width=True, hide_index=True)
...
def render_premarket_futures_snapshot(mkt, premarket_data):
    ...
    if lead_changes:
        ...
        st.info(
            f"Pre-open average move: {avg_move:+.2f}%. "
            "For the authoritative risk-on / risk-off verdict, see the REGIME MONITOR tab."
        )
    else:
...
def render_housing_alerts(fred):
    ...
    if m30 is not None:
        if m30 > 7.5:
            terminal_badge(f"30yr mortgage at {m30:.2f}% — affordability severely constrained", "error")
        elif m30 > 6.5:
            terminal_badge(f"30yr mortgage at {m30:.2f}% — housing affordability stressed", "warning")
        else:
            terminal_badge(f"30yr mortgage at {m30:.2f}%", "success")

    if hy_v is not None and hy_v > 500:
        terminal_badge(f"HY credit spread at {hy_v:.0f} bp — credit conditions tightening", "error")
...
def render_metals(mkt):
    ...
    if gold is not None and gold > 3000:
        terminal_badge(f"Gold at ${gold:,.0f}/oz — elevated safe-haven demand signal.", "warning")
    if copper is not None and copper < 3.5:
        terminal_badge(f"Copper at ${copper:.2f}/lb — weak industrial demand signal.", "warning")
...
def render_global_macro(fred, mkt):
    ...
    if dxy_v is not None and dxy.get("strengthening") and dxy_v > 103:
        terminal_badge("Dollar strengthening — global financial conditions tightening", "warning")
    if dxy_v is not None and dxy_v > 107:
        terminal_badge("DXY above 107 — historical EM stress threshold breached", "error")
...
def render_options_derivatives(mkt, opts, skew_idx, vix_term, vix_v,
    ...
    if backwardation:
        terminal_badge("VIX Backwardation detected — near-term fear spike, historically precedes sharp drawdowns", "error")
    if pcr is not None and pcr > 1.5:
        terminal_badge(f"Extreme put buying (PCR {pcr:.2f}) — possible panic hedge or contrarian buy signal", "error")
    elif pcr is not None and pcr > 1.2:
        terminal_badge(f"Put/Call Ratio elevated at {pcr:.2f} — bearish positioning dominates", "warning")
    if skew_value is not None and skew_value > 140:
        terminal_badge(f"CBOE SKEW at {skew_value:.0f} — market pricing in significant tail/crash risk", "error")
    if vvix is not None and vvix > 100:
        terminal_badge(f"VVIX elevated at {vvix:.1f} — heavy demand for VIX options, institutions hedging tails", "warning")
    if total_gex is not None and total_gex < 0:
        terminal_badge(f"Negative GEX detected (${total_gex/1e9:.2f}B) — dealers SHORT gamma, moves will be AMPLIFIED", "error")
...
def render_liquidity_conditions(fred, mkt, treasury, sofr_data, amihud_data,
    ...
    if liq_score is not None and liq_score > 1.5:
        terminal_badge(f"Liquidity Stress: Composite score {liq_score:.2f} — multiple indicators signaling funding pressure.", "error")
    elif liq_score is not None and liq_score > 0.5:
        terminal_badge(f"Liquidity Tightening: Composite score {liq_score:.2f} — conditions are deteriorating.", "warning")
    else:
        terminal_badge(f"Liquidity conditions: {liq_label} (score: {liq_score:.2f})" if liq_score is not None else "Liquidity data loading…", "success")

    if t3m_v is not None and t3m_v < 0:
        terminal_badge(f"Yield Curve Inverted (10Y-3M): {t3m_v:.2f}% — historically precedes recessions by 6–18 months.", "error")
    if ted_v is not None and ted_v > 0.5:
        terminal_badge(f"TED Spread elevated at {ted_v:.3f}% — interbank funding stress signal.", "warning")
    if move_v is not None and move_v > 130:
        terminal_badge(f"MOVE Index at {move_v:.0f} — bond market volatility elevated, fixed income liquidity impaired.", "warning")
    if drt_v is not None and drt_v > 40:
        terminal_badge(f"Loan Officer Tightening Standards at {drt_v:.0f}% — credit availability severely restricted.", "error")
...
def renderbondauctionsyields(fred, mkt, treasury):
    ...
    if spread_210 is not None and spread_210 < 0:
        terminal_badge(f"Yield curve INVERTED (2s10s = {spread_210:+.3f}%) — historical recession precursor (avg lead 6-18 months).", "error")
    elif spread_210 is not None and spread_210 < 0.25:
        terminal_badge(f"Yield curve flat (2s10s = {spread_210:+.3f}%) — watch for inversion.", "warning")
    else:
        terminal_badge(
    ...
    if log:
        ...
        st.dataframe(style_dataframe(df_log), use_container_width=True, hide_index=True)
        st.caption(
...
def render_institutional_flows(fred, cot_data, ici_data, mmf_history, inst13f,
    ...
    if inst_score.get("score") is not None and inst_score["score"] > 1.5:
        terminal_badge("Institutional Withdrawal: Multiple signals show institutions moving to cash — liquidity risk elevated 4–8 weeks ahead.", "error")
    elif inst_score.get("score") is not None and inst_score["score"] > 0.5:
        terminal_badge("Institutions are reducing equity exposure — watch for liquidity deterioration.", "warning")
    else:
        label = inst_score.get("label", "Loading…")
        score = inst_score.get("score")
        terminal_badge(f"Institutional positioning: {label}" + (f" (score: {score:.2f})" if score is not None else ""), "success")

    if wrmfns_v is not None and wrmfns_v > 5000:
        st.info(
            f"Retail MMF assets at ${wrmfns_v:,.0f}B — elevated cash buildup. "
            "See the REGIME MONITOR tab for the current risk-off / liquidity verdict."
        )

    if cot_data and "SP500_Emini" in cot_data:
        net = cot_data["SP500_Emini"].get("net_nc", 0)
        if net < -200000:
            terminal_badge(f"COT: Large specs NET SHORT S&P 500 futures ({net:,.0f} contracts) — extreme bearish institutional positioning.", "error")
        elif net < 0:
            terminal_badge(f"COT: Large specs net short S&P 500 ({net:,.0f}) — defensive positioning.", "warning")
...
def _x_intel_latest_theme_entry(analyzed, theme):
    candidates = []
    for item in analyzed or []:
        if _x_intel_infer_theme(item) != theme:
            continue
...
def _x_intel_build_levels_chart(item, title_text, color):
    analysis = item.get("analysis") or {}
    points = _x_intel_dashboard_points(item)
    if not points:
        return None
    ...
    fig.update_layout(
        ...
        xaxis=dict(title="Extracted levels", tickangle=-18, showgrid=False),
        yaxis=dict(title=analysis.get("metric", "Level"), gridcolor="#1e2d3d", zeroline=False))
    apply_house_style(fig)
    return fig
...
def _render_x_intel_theme_gallery(items, key_prefix):
    ...
    for idx, item in enumerate(items):
        analysis = item.get("analysis") or {}
        image_path = item.get("image_path")
        author_handle = item.get("author_handle", "unknown")
        likes = int(item.get("likes") or 0)
        retweets = int(item.get("retweets") or 0)

        with cols[idx % 2]:
            with st.expander(
                f"@{author_handle} · {analysis.get('title', 'Untitled')} · {likes} {retweets}",
                expanded=False):
                if image_path and os.path.exists(image_path):
                    st.image(image_path, use_container_width=True)
                st.caption(f"[Original tweet]({item.get('url', '')})")
                st.markdown(f"**{analysis.get('title', 'Untitled')}**")
                st.markdown(
                    f"`{analysis.get('source_service', 'Unknown')}`  \n"
                    f"Metric: {analysis.get('metric', 'Unknown')}  \n"
                    f"Time range: {analysis.get('time_range', 'Unknown')}  \n"
                    f"Latest value: {analysis.get('latest_value', 'Unknown')}"
                )
                st.info(analysis.get("signal_for_dashboard", "No actionable signal extracted."))
                key_levels = analysis.get("key_levels") or []
                if key_levels:
                    st.markdown("Key levels: " + ", ".join(str(level) for level in key_levels))
...
def render_singlestock_vs_index_vol(ssdata):
    ...
    if current is not None and current >= SSVOL_EXTREME_THRESHOLD:
        terminal_badge(
            f"Spread at {current:.2f} pts — widest since 2008. "
...
def render_sentiment_framework(mkt, opts, skew_idx, fg, aaii, vix_term,
    ...
    if composite_fear is not None and composite_fear >= 7.5:
        ...
        terminal_badge("Sentiment Framework: Elevated fear across multiple indicators.", "warning")
    else:
        terminal_badge(f"Sentiment: {cf_label}" + (f" (score: {composite_fear:.1f}/10)" if composite_fear is not None else ""), "success")
...
def render_x_intelligence(x_data):
    ...
    def _badge(text, fg, bg):
        return (
            ...
            f"background:{bg};color:{fg};font-size:12px;font-weight:700;margin-right:8px'>"
            f"{text}</span>"
        )
    ...
    summary_df = _x_intel_account_summary(posts, analyzed)
    if not summary_df.empty:
        st.markdown("**Tracked Accounts**")
        st.dataframe(style_dataframe(summary_df), use_container_width=True, hide_index=True)

    cta_item = _x_intel_latest_theme_entry(analyzed, "cta")
    gamma_item = _x_intel_latest_theme_entry(analyzed, "option_gamma")
    cta_items = _x_intel_theme_entries(analyzed, "cta")
    gamma_items = _x_intel_theme_entries(analyzed, "option_gamma")

    graph_cols = st.columns(2)
    with graph_cols[0]:
        st.markdown("**CTA Signal Graph**")
        if cta_item:
            cta_analysis = cta_item.get("analysis") or {}
            st.caption(f"Latest CTA chart: @{cta_item.get('author_handle', 'unknown')} · {cta_analysis.get('title', 'Untitled')}")
            st.info(cta_analysis.get("signal_for_dashboard", "No CTA macro signal extracted."))
            fig = _x_intel_build_levels_chart(cta_item, "CTA Levels From Latest Scraped X Post", "#22c55e")
            if fig is not None:
                apply_house_style(fig)

                st.plotly_chart(fig, use_container_width=True, key="x_intel_cta_chart")
        else:
            st.info("No analyzed CTA chart with structured numeric levels yet. Re-run `python3 cli/main.py run --skip-scrape --max-images 60` after the new analyzer schema is in place.")

        st.markdown("**CTA Source Images**")
        _render_x_intel_theme_gallery(cta_items, "cta")

    with graph_cols[1]:
        st.markdown("**Option Gamma Graph**")
        if gamma_item:
            gamma_analysis = gamma_item.get("analysis") or {}
            st.caption(f"Latest gamma chart: @{gamma_item.get('author_handle', 'unknown')} · {gamma_analysis.get('title', 'Untitled')}")
            st.info(gamma_analysis.get("signal_for_dashboard", "No option gamma macro signal extracted."))
            fig = _x_intel_build_levels_chart(gamma_item, "Option Gamma Levels From Latest Scraped X Post", "#f59e0b")
            if fig is not None:
                apply_house_style(fig)

                st.plotly_chart(fig, use_container_width=True, key="x_intel_gamma_chart")
        else:
            st.info("No analyzed option-gamma chart with structured numeric levels yet. Re-run `python3 cli/main.py run --skip-scrape --max-images 60` after the new analyzer schema is in place.")

        st.markdown("**Option Gamma Source Images**")
        _render_x_intel_theme_gallery(gamma_items, "gamma")
    ...
    for item in analyzed:
        ...
        with st.expander(
            f"@{author_handle} ({followers:,} followers) · {title} · {likes} {retweets}",
            expanded=False):
            ...
            with right_col:
                ...
                st.markdown(
                    _badge(f"Trend: {trend}", trend_fg, trend_bg)
                    + _badge(f"Confidence: {confidence}", conf_fg, conf_bg),
                    unsafe_allow_html=True)
                st.info(analysis.get("signal_for_dashboard", "No actionable signal extracted."))
                st.markdown(f"*{analysis.get('author_interpretation', 'No author interpretation extracted.')}*")
                st.markdown(f"Community sentiment: **{analysis.get('community_sentiment', 'mixed')}**")
                ...
                for notable_text in (analysis.get("notable_replies") or [])[:3]:
...
def main():
    ...
    with st.status("Loading core dashboard data…", expanded=False) as status:
        ...
        naaim = fetch_naaim()
        cape = fetch_shiller_cape()
        # Compute regime consensus once here so the header and Regime Monitor tab
        # never block the rest of the UI re-running detectors.
        regime_precomputed = get_regime_consensus(fred, mkt)
    ...
    energy_curve_regime = compute_regime_state(
        ...
        energy_curve=futures_curve).get("curve_regime")
    if energy_curve_regime:
        ...
        st.markdown(
            f'<div style="display:inline-block;background:{COLORS["panel"]};border:1px solid {energy_regime_color};'
            f'color:{energy_regime_color};padding:6px 18px;border-radius:8px;font-weight:700;'
            f'font-size:15px;margin-bottom:12px">WTI Curve: {energy_curve_regime}</div>',
            unsafe_allow_html=True)
    ...
    with kpi_cols[0]:
        kpi_tile("GDP (GDPNow)",
                 fmt_pct(gdp_v, decimals=1),
                 delta=f"{fmt_pct(gdp_v - 2, decimals=1, signed=True)} vs 2% trend" if gdp_v is not None else None,
                 delta_color="normal")
    with kpi_cols[1]:
        kpi_tile("CPI Inflation",
                 fmt_pct(cpi_v, decimals=1),
                 delta=f"{fmt_pct(cpi_v - 2, decimals=1, signed=True)} vs 2% target" if cpi_v is not None else None,
                 delta_color="inverse")
    with kpi_cols[2]:
        kpi_tile("Unemployment",
                 fmt_pct(un_v, decimals=1),
                 delta=f"{fmt_pct(un_v - 4, decimals=1, signed=True)} vs 4% natural" if un_v is not None else None,
                 delta_color="inverse")
    with kpi_cols[3]:
        kpi_tile("Fed Funds Rate",
                 fmt_pct(dff_v, decimals=2))
    with kpi_cols[4]:
        kpi_tile("Recession Prob",
                 fmt_pct(rec_v, decimals=1),
                 delta=f"{fmt_pct(rec_v - 20, decimals=1, signed=True)} vs 20% alert" if rec_v is not None else None,
                 delta_color="inverse")
    with kpi_cols[5]:
        kpi_tile("CAPE Ratio",
    ...
    # ── TABS ────────────────────────────────────────────────────────────────
    if "SENTIMENT" not in visible_sections:
        visible_sections = visible_sections + ["SENTIMENT"]
    ...
    # ── TAB 0: REGIME MONITOR ──────────────────────────────────────────────
    if "REGIME MONITOR" in tab_map:
        with tab_map["REGIME MONITOR"]:
            render_regime_monitor(fred, mkt, precomputed=regime_precomputed)
    ...
    if "MARKETS" in tab_map:
        with tab_map["MARKETS"]:
            _render_section_refresh(
                "markets_sentiment",
                [fetch_market, fetch_premarket_snapshot])
            with st.spinner("Loading market data…"):
                premarket_data = fetch_premarket_snapshot()
            quality_rotation = compute_quality_rotation(mkt)
            render_tab_summary("MARKETS", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape)
            render_premarket_futures_snapshot(mkt, premarket_data)

            # Market KPIs row — prices & breadth only (sentiment gauges live in Sentiment Framework)
            ...
            with qr1:
                ...
                st.markdown(
                    f'<div style="background:#161b27;border:1px solid #3b82f6;border-radius:10px;'
                    f'padding:14px 16px;margin-bottom:12px;">'
                    f'<div style="color:#94a3b8;font-size:11px;text-transform:uppercase;letter-spacing:.08em">'
                    f'Risk-on / off Verdict</div>'
                    f'<div style="color:#e2e8f0;font-size:14px;margin-top:6px;">'
                    f'See the <b>Regime Monitor</b> tab for the authoritative multi-detector consensus.</div>'
                    f'</div>',
                    unsafe_allow_html=True)
                st.markdown(
                    f'<div style="background:#161b27;border:1px solid #1e2d3d;border-radius:10px;'
...
- If one is positive and one is negative: mixed signal, so treat it as neutral.
    ...
    if "ENERGY" in tab_map:
        with tab_map["ENERGY"]:
            render_tab_summary("ENERGY", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape)
        ...
        with tab_map["NEWS & SIGNALS"]:
            ...
            with sig_cols[0]:
                ...
                for sid, label in [("GDPNOW","GDPNow"),("USSLIND","LEI"),("CFNAI","CFNAI")]:
                    ...
                    dot = "OK" if c=="#34d399" else "ALERT" if c=="#f87171" else "WATCH"
    ...
    if "LIQUIDITY" in tab_map:
        with tab_map["LIQUIDITY"]:
            _render_section_refresh(
            ...
            with st.spinner("Loading liquidity conditions data…"):
                ...
                fomc_path = compute_fomc_implied_path(sofr_strip)
                amihud_data = fetch_amihud_illiquidity("SPY", lookback=30)
            render_tab_summary("LIQUIDITY", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape)
    ...
    if "FLOWS" in tab_map:
        with tab_map["FLOWS"]:
            ...
            with st.spinner("Loading institutional flow data…"):
                ...
                sg_cta = fetch_sg_cta_index_performance()
            inst_score = compute_institutional_participation_score(cot_data, ici_data, mmf_history, fred)
            render_tab_summary("FLOWS", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape, extra={"inst_score": inst_score})
            render_institutional_flows(
                fred, cot_data, ici_data, mmf_history, inst13f,
                cta_model=cta_model, sg_cta=sg_cta
            )

    if "COMPOSITES" in tab_map:
        with tab_map["COMPOSITES"]:
            _render_section_refresh(
                "gs_style_composites",
            ...
            with st.spinner("Loading composite inputs…"):
                opts = fetch_options_indicators()
            render_tab_summary("COMPOSITES", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape)
    ...
    if "AI ANALYSIS" in tab_map:
        with tab_map["AI ANALYSIS"]:
            render_tab_summary("AI ANALYSIS", fred, treasury=treasury, mkt=mkt, fg=fg, naaim=naaim, cape=cape)
            render_ai_macro_analysis()

    if "X INTEL" in tab_map:
        with tab_map["X INTEL"]:
    ...
    if prepared_html_report:
        st.download_button(
            label="Download Full Offline Dashboard (HTML)",
